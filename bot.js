...
client.on('ready', function() {
    client.user.setGame(`Type 4play `,"http://twitch.tv/Baktash_183")
...
if (message.content.startsWith(adminprefix + 'game')) {
  client.user.setGame(argresult);
    message.channel.sendMessage(`**${argresult} **  The Bot Game Changed __Done .__** **`)
} else 
  if (message.content.startsWith(adminprefix + 'name')) {
client.user.setUsername(argresult).then
    message.channel.sendMessage(`**${argresult}** :**  The Bot Name Changed __Done .__**`)
return message.reply("**Ù„Ø§ ÙŠÙ…ÙƒÙ†Ùƒ ØªØºÙŠÙŠØ± Ø§Ù„Ø§Ø³Ù… ÙŠØ¬Ø¨ Ø¹Ù„ÙŠÙƒ Ø§Ù„Ø§Ù†ØªØ¸Ø¢Ø± Ù„Ù…Ø¯Ø© Ø³Ø§Ø¹ØªÙŠÙ† . **");
} else
  if (message.content.startsWith(adminprefix + 'avatar')) {
client.user.setAvatar(argresult);
  message.channel.sendMessage(`**${argresult}** **  The Bot avatar Changed __Done .__**`);
      } else     
